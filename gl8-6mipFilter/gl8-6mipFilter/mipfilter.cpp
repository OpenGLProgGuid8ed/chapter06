...
mipFilter::mipFilter(QGLWidget *parent)
	: QGLWidget(parent)
{
	ui.setupUi(this);
	startTimer(10);
...
void mipFilter::timerEvent(QTimerEvent*)
{
	updateGL();
}

void mipFilter::initializeGL()
{
	...
	//GL_TEXTURE_MAG_FILTER 在纹理放大时使用  
	//GL_NEAREST禁止滤波，GL_LINEAR 线性滤波
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);

    delete [] data;
}

void mipFilter::paintGL()
{
...
void mipFilter::resizeGL(int w,int h)
{
	if(0 == h)
		h = 1;
