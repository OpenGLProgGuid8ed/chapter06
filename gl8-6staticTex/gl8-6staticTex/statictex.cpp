...
staticTex::staticTex(QGLWidget *parent)
	: QGLWidget(parent)
{
	ui.setupUi(this);
	startTimer(100);
...
void staticTex::timerEvent(QTimerEvent*)
{
	updateGL();
}

void staticTex::initializeGL()
{
...
void staticTex::resizeGL(int w,int h)
{
	if(0 == h)
		h = 1;
